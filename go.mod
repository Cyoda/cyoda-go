...
require (
	...
	github.com/cyoda-platform/cyoda-go/plugins/memory v0.8.2
	github.com/cyoda-platform/cyoda-go/plugins/postgres v0.8.2
	github.com/cyoda-platform/cyoda-go/plugins/sqlite v0.8.2
