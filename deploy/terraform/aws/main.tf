...
resource "aws_db_subnet_group" "main" {
  ...
  subnet_ids  = aws_subnet.private[*].id
  description = "Subnet group for cyoda RDS instance"
}
...
locals {
  postgres_dsn = "postgres://${var.db_username}:${var.db_password}@${aws_db_instance.postgres.address}:5432/${var.db_name}?sslmode=require"
}
