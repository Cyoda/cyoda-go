...
type CreateParams struct {
	...
	// bodies, except that a joined request rejects it whatever the body
	// (below). Default 100, maximum 1000; values outside (0, 1000] are
