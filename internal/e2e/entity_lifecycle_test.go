...
func TestEntityLifecycle_Update(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "lc-wf", "initialState": "NONE", "active": true,
			"states": {
...
func TestEntityLifecycle_UpdateWithTransition(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "lc2-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
				"CREATED": {"transitions": [{"name": "approve", "next": "APPROVED", "manual": true}]},
				"APPROVED": {}
...
func TestEntityLifecycle_AvailableTransitions(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "lc3-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
				"CREATED": {"transitions": [
...
func TestEntityLifecycle_InvalidTransition(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "lc5-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
				"CREATED": {"transitions": [{"name": "approve", "next": "APPROVED", "manual": true}]},
				"APPROVED": {}
...
func TestEntityLifecycle_DisabledTransition(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "lc6-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
				"CREATED": {"transitions": [
...
func TestEntityLifecycle_VersionHistory(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "lc7-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
				"CREATED": {"transitions": [{"name": "approve", "next": "APPROVED", "manual": true}]},
				"APPROVED": {}
...
func TestEntityLifecycle_TemporalAsAt(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "lc8-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
				"CREATED": {}
			}
...
func TestEntityLifecycle_TemporalByTransactionID(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "lc8b-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
				"CREATED": {}
			}
...
func TestEntityLifecycle_BatchCreate(t *testing.T) {
	...
	setupModelWithWorkflow(t, model, `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "lc9-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
				"CREATED": {}
			}
...
func TestEntityLifecycle_Statistics(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "lc10-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
				"CREATED": {"transitions": [{"name": "approve", "next": "APPROVED", "manual": true}]},
				"APPROVED": {}
...
func TestEntityLifecycle_PreservesLargeIntPrecision(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "precision-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
				"CREATED": {}
			}
...
func TestEntityLifecycle_CollectionCreate50(t *testing.T) {
	...
	setupModelWithWorkflow(t, model, `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.0", "name": "col50-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
				"CREATED": {}
			}
