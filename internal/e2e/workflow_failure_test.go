...
func TestWorkflowFailure_ProcessorWarnings(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.1", "name": "warn-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false,
...
func TestWorkflowFailure_CriteriaError(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.1", "name": "criteria-fail-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false}]},
...
func TestWorkflowFailure_ProcessorContextCancelled(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.1", "name": "timeout-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false,
...
func TestWorkflowFailure_ProcessorPanic(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.1", "name": "panic-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false,
...
func TestWorkflowFailure_AsyncNewTxProcessorFailure(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.1", "name": "async-fail-wf", "initialState": "NONE", "active": true,
			"states": {
				"NONE": {"transitions": [{"name": "init", "next": "CREATED", "manual": false,
...
func TestWorkflowFailure_AsyncNewTxSuccessThenCascadeFails(t *testing.T) {
	...
	wf := `{
		"importMode": "REPLACE",
		"workflows": [{
			"version": "1.1", "name": "async-then-fail-wf", "initialState": "NONE", "active": true,
			"states": {
